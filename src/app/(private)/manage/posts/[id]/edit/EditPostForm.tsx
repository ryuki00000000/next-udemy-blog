        ...
        <div className="container mx-auto mt-10">
            ...
            <form action={formAction}className="space-y-4">
                <div>
                    ...
                    <Input type="text" id="title" name="title" placeholder="タイトルを入力してください" value={title} onChange={(e)=> setTitle(e.target.value) }></Input>
                    {state.errors.title && (
                ...
                <div>
                    ...
                    <TextareaAutosize id="content" name="content" className="w-full border p-2" placeholder="Markdown形式で入力してください" minRows={8} value={content} onChange={handleContentChange}></TextareaAutosize>
                ...
                {preview && (
                    <div className="border p-4 bh-gray-50 prose max-w-none">
                        <ReactMarkdown
